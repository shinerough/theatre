  ...
  <div class="relative z-10 bg-yellow-300 shadow">
      ...
      <div class="relative flex items-center justify-between h-16">
        <div class="flex items-center px-2 lg:px-0">
          <a class="flex-shrink-0" href="<?= ROOT_DIR ?>">
            <img class="block lg:hidden h-12 w-16" src="<?= ROOT_DIR ?>assets/images/theatre_logo.png" alt="Logo">
            <img class="hidden lg:block h-12 w-auto" src="<?= ROOT_DIR ?>assets/images/theatre_logo.png" alt="Logo">
          </a>
    ...
    <div x-show="menu" class="block md:hidden">
      <div class="px-2 pt-2 pb-3">
        <a href="" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold hover:bg-yellow-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Blog </a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold hover:bg-yellow-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Login </a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold# hover:bg-yellow-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Register </a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold hover:bg-yellow-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Account </a>
      </div>
    </div>
  </div>
</nav>
